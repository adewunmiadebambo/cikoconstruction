...
// send form to mail
$body = 'Beloew are the data entered from the careers form:'."\n"
        .'Full Name: '.$name."\n"
        .'Email: '.$email."\n"
        .'Telephone: '.$telephone."\n"
        .'Message: '.$message."\n"
        .'<a href="http://www.cikoakoconstructions.com/'.$filepath.'">Click here</a> to download CV'."\n";
$to = 'crespo1678@yahoo.com';
$subject = 'Career Application Form';
$header = 'From:noreply@cikoakoconstructions.com';
